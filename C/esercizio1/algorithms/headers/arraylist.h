 ...
 * 
 *  The complete original project with documentation can be found on:
 *  github.com/sievericcardo/array_list
 * 
 *  File:   arraylist.h
...
int ArrayList_get_nearest_index(ArrayList* , void* , int (*fptr)(void*, void*));
